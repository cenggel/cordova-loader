...
*Note: the compiler will only run once due to live reload loop. If you want to manually rerun the compiler just delete the private/cordova/[version]/[platform] file you want to recompile.*
